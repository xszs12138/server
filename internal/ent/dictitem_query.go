...
func (_q *DictItemQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *DictItemQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *DictItemQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *DictItemQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *DictItemQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *DictItemQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(dictitem.FieldDictType).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *DictItemQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(dictitem.Table, dictitem.Columns, sqlgraph.NewFieldSpec(dictitem.FieldID, field.TypeUint64))
	_spec.From = _q.sql
