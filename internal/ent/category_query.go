...
func (_q *CategoryQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CategoryQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *CategoryQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CategoryQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *CategoryQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *CategoryQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CategoryQuery) loadPosts(ctx context.Context, query *PostQuery, nodes []*Category, init func(*Category), assign func(*Category, *Post)) error {
	...
	for _, n := range neighbors {
		fk := n.CategoryId
		if fk == nil {
			return fmt.Errorf(`foreign-key "categoryId" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
