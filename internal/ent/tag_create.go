...
func (_c *TagCreate) SetSort(v int) *TagCreate {
	_c.mutation.SetSort(v)
	return _c
}

// SetNillableSort sets the "sort" field if the given value is not nil.
func (_c *TagCreate) SetNillableSort(v *int) *TagCreate {
	if v != nil {
		_c.SetSort(*v)
	}
	return _c
...
func (_c *TagCreate) SetVisible(v bool) *TagCreate {
	_c.mutation.SetVisible(v)
	return _c
}

// SetNillableVisible sets the "visible" field if the given value is not nil.
func (_c *TagCreate) SetNillableVisible(v *bool) *TagCreate {
	if v != nil {
		_c.SetVisible(*v)
	}
	return _c
...
func (_c *TagCreate) AddPostIDs(ids ...uint64) *TagCreate {
...
func (_c *TagCreate) check() error {
	...
	if _, ok := _c.mutation.Sort(); !ok {
		return &ValidationError{Name: "sort", err: errors.New(`ent: missing required field "Tag.sort"`)}
	}
	if _, ok := _c.mutation.Visible(); !ok {
		return &ValidationError{Name: "visible", err: errors.New(`ent: missing required field "Tag.visible"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
